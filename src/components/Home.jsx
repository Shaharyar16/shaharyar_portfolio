  ...
  return (
    <>
      <div className="flex flex-col items-center pb-20 px-4 sm:px-6 md:px-10">
        {/* Profile Image */}
        <div className="w-36 h-36 sm:w-44 sm:h-44 flex justify-center items-center overflow-hidden border-teal-800 border-3 rounded-full bg-gradient-to-r from-indigo-500 to-emerald-500 opacity-100 mt-6">
          <img
        ...
        {/* Name */}
        <h1 className="text-3xl sm:text-4xl mt-7 bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent font-bold">
          Shaharyar Zia
        </h1>
        ...
        <div className="text-gray-500 text-center mt-3 max-w-full sm:max-w-3xl mx-auto px-2 sm:px-0">
        ...
        <div className="flex flex-col sm:flex-row gap-5 sm:gap-7 mt-10">
          <button
