        ...
        <div>
          ...
          <div className="mt-14 flex justify-center items-center">
            <div className="w-[65%]">
              ...
              <div className="flex justify-between items-center text-center mt-14 px-9">
                <div className="text-gray-600 text-[14px]">
                  <span className="text-blue-600 block font-extrabold text-xl">
                    20+
                  </span>
                  Learnings
                </div>
                <div className="text-gray-600 text-[14px]">
                  <span className="text-teal-400 block font-extrabold text-xl">
                    Skills
                  </span>
                  React, Tailwind, N8N
                </div>
            ...
            <div>
              <div className="bg-gray-800 ml-60 rounded-2xl">
                <img
                  className="w-[150%] h-[150%] shadow-2xl m-auto"
                  src={myImage}
                  alt="Shaharyar"
                />
              </div>
