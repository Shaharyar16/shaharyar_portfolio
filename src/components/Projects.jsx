...
const ProjectCard = ({ title, description, modules, techStack, login, link, otherProjects }) => {
  return (
    <div className="bg-white border max-md:text-[13px] border-gray-200 px-8 py-8 max-md:px-5 rounded-2xl w-[90%] max-md:w-[100%] hover:scale-105 transition-all duration-300 hover:shadow-lg hover:bg-gradient-to-r hover:from-blue-50 hover:to-teal-50">
      <h3 className="text-2xl font-bold text-black mb-4 max-md:text-xl">{title}</h3>
      <p className="text-gray-600 text-sm mb-6 max-md:text-[13px]">{description}</p>

      <div className="mb-6">
        <h4 className="font-semibold text-gray-700 mb-2 max-md:text-sm">Modules & Features:</h4>
      ...
      <div className="mb-6 max-md:ml-6">
        <a
          href={link}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block mt-2 px-6 py-2 bg-gradient-to-r from-blue-500 to-teal-400 text-white font-semibold rounded-2xl shadow-md hover:from-blue-600 hover:to-teal-500 transition-all duration-200 max-md:w-[90%] text-center"
        >
          View Live Project
        </a>
      </div>
...
const Projects = () => {
  ...
  return (
    <>
      ...
      <div className="py-[4rem] px-[6rem] max-md:px-[1rem] flex flex-col items-center gap-12">
